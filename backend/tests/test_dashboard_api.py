...
def test_receita_e_despesa_simples_calculam_resultado(client):
    ...
    client.post(
        "/transacoes",
        json={"data_compra": "2026-09-05", "valor": 3000, "tipo_movimento": "despesa", "conta_id": conta["id"]},
    )
...
def test_estorno_vinculado_reduz_despesa_liquida_mas_nao_conta_como_receita(client):
    ...
    despesa = client.post(
        "/transacoes",
        json={"data_compra": "2026-09-05", "valor": 300, "tipo_movimento": "despesa", "conta_id": conta["id"]},
    ).json()
    client.post(
        "/transacoes",
        json={
...
def test_aplicacao_e_retirada_compoe_reservas(client):
    ...
    client.post(
        "/transacoes",
        json={"data_compra": "2026-09-05", "valor": 500, "tipo_movimento": "aplicacao", "conta_id": conta["id"]},
    )
    client.post(
        "/transacoes",
        json={"data_compra": "2026-09-10", "valor": 200, "tipo_movimento": "retirada", "conta_id": conta["id"]},
    )
...
def test_evolucao_acumula_resultado_entre_meses(client):
    ...
    client.post(
        "/transacoes",
        json={"data_compra": "2026-08-10", "valor": 400, "tipo_movimento": "despesa", "conta_id": conta["id"]},
    )
    client.post(
        "/transacoes",
    ...
    client.post(
        "/transacoes",
        json={"data_compra": "2026-09-10", "valor": 700, "tipo_movimento": "despesa", "conta_id": conta["id"]},
    )
